        ...
        <div class="custom-box">
            ...
            <?php $post_meta = array(array(
                ...
                array(
                    ...
                    "label"=>	__("Disable the author biography.",'dt_themes'),
                    "tooltip"=>	__("By default the author biography will display when viewing your posts. You can choose to disable it here.",'dt_themes')
                ));
            $count = 1;
