...
function dttheme_default_option() {
	...
	$general = array(
				...
				"disable-picker"		=>"on",
				"show-footer-logo"		=>"on",
				"copyright-text" => 'Copyright &copy; 2013 Soulmedic Theme All Rights Reserved | <a href="http://themeforest.net/user/designthemes" title=""> Design Themes </a>');
				
	$appearance = array("disable-menu-settings" => "true","disable-typography-settings" => "true","disable-boddy-settings" => "true","skin" => "blue" , "header_type" =>"header1");
