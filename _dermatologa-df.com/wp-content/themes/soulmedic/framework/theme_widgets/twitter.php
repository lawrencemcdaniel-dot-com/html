...
<?php
	...
	function widget($args, $instance) {
		...
		echo $before_widget;			
			...
			if ( !empty( $title ) ) { echo $before_title . "<a href='//twitter.com/$username/' title='".strip_tags($title)."'>".$title ."</a>". $after_title; };
				...
				if($twitter && is_array($twitter)) {
					foreach( $twitter as $tweet ):
						...
						echo '<li class="tweet">';
								...
								if( $display_avatar )
								echo '<span class="tweet-thumb"><a href="//twitter.com/'.$username.'" title=""><img src="'.$tweet->user->profile_image_url.'" alt="" /></a></span>';
