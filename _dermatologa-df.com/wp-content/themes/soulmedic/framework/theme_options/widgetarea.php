    ...
    <div id="for-custom-widget-area" class="tab-content">
      <div class="bpanel-box">
        ...
        <div class="box-content">
          ...
          <p class="note"><?php _e("You can create widget areas here, and assign them in individual paage/post",'dt_themes');?></p>
          <div class="bpanel-option-set">
            <input type="button" value="<?php _e('Add New Widget Area','dt_themes');?>" class="black mytheme_add_widgetarea" />
