            ...
            <div class="bpanel-box">
                    ...
                    <div class="box-content">
                        ...
                        <div class="image-preview-container">
                            <input id="mytheme-logo" name="mytheme[general][logo-url]" type="text" class="uploadfield" readonly
                        ...
                        <div class="image-preview-container">
                          <input id="mytheme-retina-logo" type="text" name="mytheme[general][retina-logo-url]" class="uploadfield" readonly 
                    ...
                    <div class="box-content">
                      ...
                      <div class="column one-fifth">
                          <?php $checked = ( "true" ==  dttheme_option('general','enable-mobile-sticky-nav') ) ? ' checked="checked"' : ''; ?>
                            ...
                            <input class="hidden" id="mytheme-enable-mobile-sticky-nav" name="mytheme[general][enable-mobile-sticky-nav]" type="checkbox" 
                            value="true" <?php echo $checked;?> />
                        </div>
