...
if ( file_exists( '/var/www/html/cms.agility360app.net/wp-content/plugins/wp-rocket/inc/front/process.php' ) && version_compare( phpversion(), '5.4' ) >= 0 ) {

	spl_autoload_register( function( $class ) {
		$rocket_path    = '/var/www/html/cms.agility360app.net/wp-content/plugins/wp-rocket/';
		$rocket_classes = [
