...
if ( file_exists( '/var/www/html/cms.agility360app.net/wp-content/plugins/wp-rocket/inc/front/process.php' ) && file_exists( '/var/www/html/cms.agility360app.net/wp-content/plugins/wp-rocket/vendor/autoload.php' ) && version_compare( phpversion(), '5.4' ) >= 0 ) {
	include '/var/www/html/cms.agility360app.net/wp-content/plugins/wp-rocket/vendor/autoload.php';
