...
if ( class_exists( 'Memcached' ) ) {
	if ( file_exists( '/var/www/html/cms.agility360app.net/wp-content/plugins/memcached-is-your-friend/memcached-class-object-cache.php' ) ) {
		require_once '/var/www/html/cms.agility360app.net/wp-content/plugins/memcached-is-your-friend/memcached-class-object-cache.php';
...
//		}
	...
	if ( file_exists(  '/var/www/html/cms.agility360app.net/wp-content/plugins/memcached-is-your-friend/memcache-class-object-cache.php' ) ) {
		require_once '/var/www/html/cms.agility360app.net/wp-content/plugins/memcached-is-your-friend/memcache-class-object-cache.php';
//		if ( defined( 'WP_DEBUG' ) && WP_DEBUG ) {
