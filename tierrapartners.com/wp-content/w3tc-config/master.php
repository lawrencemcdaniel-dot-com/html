<?php exit; ?>{
    ...
    "cdn.custom.files": [
        ...
        "{plugins_dir}\/*.jpg",
        "{plugins_dir}\/*.png",
        "{wp_content_dir}\/themes\/x\/framework\/fonts\/font_awesome\/*",
        "{plugins_dir}\/the-grid\/frontend\/assets\/fonts\/*",
    ...
    "cdn.cf.key": "AKIAITJIPRYNYUUUE3QA",
    "cdn.cf.secret": "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",
    "cdn.cf.bucket": "www.tierrapartners.com",
    "cdn.cf.bucket.location": "us-east-1",
    "cdn.cf.id": "d2qxcitaij4dv4",
    "cdn.cf.cname": [],
    "cdn.cf.ssl": "enabled",
    "cdn.cf2.key": "",
    "cdn.cf2.secret": "",
    ...
    "cdn.reject.files": [
        ...
        "{uploads_dir}\/la_icon_sets\/*",
        "{uploads_dir}\/revslider\/*",
        "{plugins_dir}\/revslider\/*"
    ],
    "cdn.reject.ssl": "0",
