...
class BSF_Envato_Activate {
	...
	public function envato_register( $args ) {
		...
		if ( $is_active ) {
			...
			$html .= '<p class="bsf-license-consent-container"><input id="bsf-license-consent" name="bsf_license_manager[consent]" type="checkbox" value="yes"' . $consent . ' /> <label for="bsf-license-consent">Save my name, email, in order to receive updates.</label></p>';
