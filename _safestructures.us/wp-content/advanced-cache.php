...
if ( file_exists( '/var/www/html/safestructures.us/wp-content/plugins/wp-rocket/inc/front/process.php' ) && version_compare( phpversion(), '5.4' ) >= 0 ) {

	spl_autoload_register( function( $class ) {
		$rocket_path    = '/var/www/html/safestructures.us/wp-content/plugins/wp-rocket/';
		$rocket_classes = [
