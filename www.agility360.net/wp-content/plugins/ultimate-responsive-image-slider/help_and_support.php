<div class="row-fluid pricing-table pricing-three-column" style="margin-top: 10px; display:block; width:100%; overflow:hidden; background:white; box-shadow: 0 0 5px hsla(0, 0%, 20%, 0.3);padding-bottom:70px">
	...
	<hr>
	<div style="margin-top:30px;margin-left:30px;">
		<h2 style="font-weight: bold;font-size: 28px;padding-top:10px;">Did you migrated site from Old Domain to New Domain?</h2>
		<h2 style="font-weight: bold;font-size: 30px;padding-top:10px;">OR</h2>
		<h2 style="font-weight: bold;font-size: 28px;padding-top:10px;">Did you implemented SSL certificate on Domain like HTTPS?</h2>
