...
$rocket_cookie_hash = '919033ebf8a9cc60f7034dadc1b03d34';
$rocket_cache_mobile = '1';
$rocket_do_caching_mobile_files = '1';
$rocket_cache_ssl = '1';
$rocket_cache_reject_uri = '(.*)/feed/?|/checkout/(.*)|/cart/|/my-account/(.*)|/wc-api/v(.*)|/wp-json/(.*)|/login2clients/';
...
$rocket_secret_cache_key = '5aaece85071a3315845470';
